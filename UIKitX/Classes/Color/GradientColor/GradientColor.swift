...
extension UIView {
    ...
    @discardableResult
    public func gradient(set: Gradients, cornerRadius: CGFloat = 0, roundEdges: Bool = false) -> UIView {
        ...
        case .warmFlame:
            ...
            self.gradient(colors: c, corner: cornerRadius, roundEdges: roundEdges)
        case .nightFade:
        ...
        case .springWarmth:
            ...
            self.gradient(colors: c, locations: [0.0, 0.01, 1.0], corner: cornerRadius, roundEdges: roundEdges)
        ...
        case .youngPassion:
            ...
            self.gradient(colors: c, locations: [0.0, 0.0, 0.21, 0.52, 0.78, 1.0], corner: cornerRadius, roundEdges: roundEdges)
        case .ladyLips:
            ...
            self.gradient(colors: c, locations: [0.0, 0.99, 1.0], corner: cornerRadius, roundEdges: roundEdges)
        ...
        case .wildApple:
            ...
            self.gradient(colors: c, corner: cornerRadius)
        ...
        case .ariellesSmile:
            ...
            self.gradient(colors: c, locations: [0.0, 0.47, 1.0], corner: cornerRadius, roundEdges: roundEdges)
