...
extension UIGradient {
    ...
    convenience public init(_ set: Gradients,
        ...
        case .warmFlame:
            ...
            self.init(colors: c, start: start, end: end, locations: locations, cornerEdges: cornerEdges, roundEdges: roundEdges, style: style, layerAt: layerAt)
        case .nightFade:
        ...
        case .springWarmth:
            ...
            self.init(colors: c, start: start, end: end, locations: locations != nil ? locations : [0.0, 0.01, 1.0], cornerEdges: cornerEdges, roundEdges: roundEdges, style: style, layerAt: layerAt)
        ...
        case .youngPassion:
            ...
            self.init(colors: c, start: start, end: end, locations: locations != nil ? locations : [0.0, 0.0, 0.21, 0.52, 0.78, 1.0], cornerEdges: cornerEdges, roundEdges: roundEdges, style: style, layerAt: layerAt)
        case .ladyLips:
            ...
            self.init(colors: c, start: start, end: end, locations: locations != nil ? locations : [0.0, 0.99, 1.0], cornerEdges: cornerEdges, roundEdges: roundEdges, style: style, layerAt: layerAt)
        ...
        case .ariellesSmile:
            ...
            self.init(colors: c, start: start, end: end, locations: locations != nil ? locations : [0.0, 0.47, 1.0], cornerEdges: cornerEdges, roundEdges: roundEdges, style: style, layerAt: layerAt)
